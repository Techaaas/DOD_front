...
const TakePhotoStat: FC<TakePhotoProps> = ({onFileSubmitTakePhoto, onFileSelectionTakePhoto}) => {
  ...
  const handleSubmit = () => {
    if (imgSrcStat){
      console.log("ddd")
      dispatch(setStatementImage(imgSrcStat));
    }
  };
      ...
      <div>
        <div className='container'>
          {imgSrcStat === null ? (
              ...
              <div>
                <img className='camera_shot' src={imgSrcStat} alt="screenshot"/>
                <button className='button_retake_photo' onClick={() => setImgSrcStat(null)}>
