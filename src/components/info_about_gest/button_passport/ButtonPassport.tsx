...
const ButtonPassport: React.FC<ButtonPassportProps> = ({onFileSubmitPassport, onFileSelectionPassport}) => {
  ...
  const handleFileSelected = () => {
    // Скрываем кнопку, которая больше не нужна
    setShowTakePhoto(false); // или setShowUpload(false), в зависимости от того, какая кнопка должна скрываться
  };
  ...
  return (
      <div className='buttons_passport'>
        ...
        {showTakePhotoPassport && (
            <div>
              <Link onClick={handleTakePhotoClick} href={'qr/photo'}>
