...
const TakePhoto:FC<TakePhotoProps> = ({onFileSubmitTakePhoto, onFileSelectionTakePhoto}) => {
  ...
  const handleSubmit = () => {
    onFileSubmitTakePhoto ? onFileSubmitTakePhoto() :
        onFileSelectionTakePhoto ? onFileSelectionTakePhoto(true) :
    console.log(onFileSelectionTakePhoto)
  };
                  ...
                  <div>
                    ...
                    <button className='button_retake_photo' onClick={() => setImg(null)}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="15" viewBox="0 0 20 15" fill="none">
                        <path d="M8.4734 14.6003C8.21738 14.8562 7.87021 15 7.50821 15C7.14621 15 6.79903 14.8562 6.54302 14.6003L0.399675 8.45695C0.143742 8.20094 -3.43323e-05 7.85376 -3.43323e-05 7.49176C-3.43323e-05 7.12976 0.143742 6.78258 0.399675 6.52657L6.54302 0.383225C6.8005 0.134545 7.14535 -0.00305748 7.50329 5.24521e-05C7.86124 0.00316334 8.20365 0.146738 8.45677 0.399855C8.70988 0.652972 8.85346 0.995378 8.85657 1.35333C8.85968 1.71127 8.72208 2.05612 8.4734 2.3136L4.77783 6.12657L17.7471 6.12657C18.1092 6.12657 18.4564 6.2704 18.7125 6.52643C18.9685 6.78245 19.1123 7.12969 19.1123 7.49176C19.1123 7.85383 18.9685 8.20107 18.7125 8.45709C18.4564 8.71311 18.1092 8.85695 17.7471 8.85695L4.77783 8.85695L8.4734 12.6699C8.72933 12.9259 8.8731 13.2731 8.8731 13.6351C8.8731 13.9971 8.72933 14.3443 8.4734 14.6003Z" fill="#FFF"/>
                      </svg>
                      Retake
                    </button>
